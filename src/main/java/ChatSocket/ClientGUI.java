...
public class ClientGUI extends JFrame {
    ...
    // Khởi tạo biến toàn cục ở ngoài
    Socket socket = null;
    String ip = "";
    int port = 0;
    String name = "";
	...
	if (btnNewButton == null) {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			// Tạo một socket đưa địa chỉ IP và Cổng port vào
			socket = new Socket(ip, port);

			// kiểm tra và bắt lỗi ngoại lệ
			...
			JOptionPane.showMessageDialog(contentPane,
			                "Error while connect, please try again!" + e,
	...
	if (lblNewLabel_2 == null) {
	    lblNewLabel_2 = new JLabel("@PhucAndTin");
